...
internal fun DocumentSnapshot.toErrorEntity(): ErrorEntryEntity? {
    ...
    return ErrorEntryEntity(
        ...
        examType = (data["examType"] as? String)?.let { ExamType.fromLabel(it) },
        ...
        difficulty = Difficulty.fromLabel(data["difficulty"] as? String),
        mistakeType = MistakeType.fromLabel(data["mistakeType"] as? String),
        ...
        status = ErrorStatus.fromLabel(data["status"] as? String),
